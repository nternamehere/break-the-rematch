...
label archery__day_0:
    ...
    "But I supposed that club members, especially their star members, have a tendency to be territorial. Perhaps it doesn't matter who I am, just that I'm here at all. A trespasser."
    ...
    satsuki "I see."
    "The young woman's calmness seems to resonate with everyone in the dojo - including me."
...
label tennis__day_0:
    ...
    "I'd been a fool not to realize it – it makes perfect sense that someone like her would be failing math."
    ...
    "Ritsuko's eyes narrow, and she bares her teeth. Her almost-shouted words caught everyone's attention, and their gazes quickly turn towards us"
    ...
    shinn "Heh. \"Things that I did with teachers\"? These are rumors, Ritusko. Not surprising that you don't know the difference between hearsay and facts."
    ritsuko "Oh? Rumors? I might not have physical evidence, but others' accounts don't lie."
    shinn "Hmph!"
    thinking "Even if I don't want to, it seems I'll have to deal with this bitch if I'm going to have any hope of moving forward with my plans."
...
label gym__day_0:
    ...
    "Touko nods, though I doubt if she caught my meaning."
    touko "I see."
...
label track__day_0:
    ...
    "Only as I arrived at the track did the heat of the day really hit me."
    shinn "Still, it's a little too late for it to be like this, no?"
    "I sigh in resignation and begin looking for my next student. Unlike the others, the Principal had barely talked about her."
...
label classroom__day_0:
    ...
    "As I looked through the notes, I recognized a familiar class name. Below it some notes had been written by the principal."
    ...
    shinn "Yes, yes..."
    "As I was about to leave, a figure suddenly emerges from the hallway and enters the room."
    ...
    "Almost before I could react she darts forward, moving to strike me in the mouth."
    shinn "Woah!"
    ...
    shinn "Remember this?"
    "It was a picture of Naoko. She was drowning in pleasure, her naked chest splattered with a load of cum."
    naoko "You..."
