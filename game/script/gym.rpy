...
label gym__first_visit:
    ...
    shinn "{i}There's plenty of material to pick from here.{/i}"
    ...
    shinn "{i}I hope she lives up to my expectations.{/i}"
    ...
    shinn "Good evening."
    shinn "{i}Looks like I wasn't expecting too much, after all.{/i}"
    ...
    shinn "{i}She seems more approachable than the others.{/i}"
    ...
    shinn "{i}Seems the principal hasn't told them anything more than that they needed tutoring.{/i}"
    touko "Pleased to meet you, Mr. Akatsuki. I was just talking to Satsuki about you. I'm sure you remember her?"
    "I nodded politely."
    shinn "{i}Satsuki... Of course{/i}"
    shinn "Yes, how could I forget?"
    "It seemed they all knew each other, which made things a little easier for me..."
    shinn "{i}Heh, depending on the depth of their relationship, I might be able to bang all of them at the same time!{/i}"
    ...
    shinn "{i}Hmm... Arew they good friends? Or maybe something more?{/i}"
    ...
    hide touko basic
    with moveoutleft
    shinn "{i}Interesting...{/i}"
    "Touko's sudden appearance had interrupted my nascent conversation with Aina, but it had also saved me the trouble of looking for the other girl."
    shinn "{i}The way Touko was looking at Aina was quite suspicious...{/i}"
    shinn "*chuckle*"
