label start:
    ...
    show bg shinn bedroom with Dissolve(3.0)
    ...
    shinn "{i}Oh, that's great.{/i}"
    shinn "{i}Heh. Looks like I didn't need to get up so early after all. But since I am already awake, I might as well get prepared now.{/i}"
