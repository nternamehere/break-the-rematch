...
label gym__day_3:
    ...
    "After all, I wasn't sure if Touko cleaned up all the mess from yesterday."
...
label touko_aina__cg_3:
    $ renpy.music.play(audio.sex, loop=True, fadeout=1.0, fadein=1.0, if_changed=True)
    if no_expose_touko:
        scene bg pool with map_fade
        "It’s painfully early in the morning.."
        "I'm surprised Aina is willing to put up with coming in this early for extra practice day after day."
        "But it’s handy for me. After all, all I’m here to get her alone and fuck her."
        "That’s what your diligence gets you, Aina."
        "Now that I have Touko’s panties with me, I have the decisive upper hand. There’s no way she’s getting out of this now."
        "I approach the swimming pool while no one else is around."
        thinking "Hmm... Wasn’t Aina supposed to be here by now?"
    ...
    if no_expose_touko:
        shinn "Guess what I’ve got with me right now?"
        "I take the panties out from my pocket."
        shinn "Take a look at those. You can still see how they’re soaked."
        "Aina looks sickened by the sudden realization."
        aina "You bastard! How could you!"
        "I proceed to lick the soiled part of the underwear."
        shinn "Mmm... I can still taste her pussy juice from when you fingered her."
        aina "You..."
        aina "You’re not going to get away with this!"
        shinn "Well, there are two ways this can go. First, I could report this to the school and tell them what you and your lover Touko did together."
        shinn "Of course, that would mean your school life would be over.."
        shinn "Or second, you could have sex with me right now, and this would all be our carefully-guarded secret."
        aina "You..."
        shinn "So? What’s it going to be? Protect your lover by tasting this dick of mine, or end things with Touko right now?"
    else:
...
label touko_aina__cg_5:
    ...
    if no_expose_touko:
        "She seems entirely composed, having no idea what’s about to happen to her."
        "Well, that’s fun too in its own way."
        "I fix my eyes on her while I walk towards the teacher’s desk."
        "As I lay my things across the desk, Touko is looking at me with an intense expression."
        shinn "What’s wrong Touko? You look awfully serious."
        touko "I have to take this seriously. This is an important class session after all."
        shinn "Well, that’s true. That’s a good attitude to take."
        touko "So? Shall we begin?"
        "She seems eager to get through this."
        "Touko takes her homework out from the bag and puts it on her desk."
        touko "Here. I got it all done just as you asked."
        shinn "Heh, that’s good. Do you think you were able to answer everything correctly?"
        touko "Umm... I’m not sure."
        shinn "That’s alright. But before I go over your work, there’s something I’d like you to see."
        touko "Huh?"
    else:
    ...
    if no_expose_touko:
        touko "No!"
        touko "What’s this even..."
        "Touko has no idea how to react to this sudden revelation. I can see her reeling as she tries to process what’s going on."
        touko "..."
        shinn "Hahahahaha!"
        shinn "Sorry Touko, I hope this isn’t too much of a surprise for you! "
        shinn "I just thought you ought to know your precious lesbian girlfriend is now a slave yo my cock! "
        touko "..."
        touko "Aina... What?"
        aina "It’s just like he said. I love Master’s cock!"
        ...
        touko "What the hell is even going on here?!"
        shinn "Well, let me bring you up to speed."
        shinn "Remember that time the two of you had sex inside the utility room recently?"
        show touko school angry arms
        touko "What!?"
        shinn "Oh, sorry, did you think you’d managed to keep that a secret?"
        shinn "I guess you might have been wondering why your panties went missing after you left them there that time."
        touko "You..."
        shinn "Hahahahaha!"
        shinn "Now you get the picture? "
        touko "You’re not going to get away with this! "
        shinn "Oh, I really wouldn’t be so sure about that."
        shinn "You’re the one who’s really been careless here."
        shinn "Those lovely scented panties you left behind really came in handy for me when I was working over your girlfriend, you know."
        touko "..."
        shinn "If you want to blame anyone for this, go ahead and blame yourself."
        touko "This can’t be..."
        shinn "Give it up, Touko."
    else:
        touko "No..."
        touko "This can't be..."
    ...
    if no_expose_touko:
        "Touko looks completely lost. She’s still desperately trying to catch up with the situation as it unfolds around her."
        touko "I..."
        ...
        "Touko looks at Aina with a pleading expression."
        touko "Aina, snap out of it! He’s using you to get me! Don’t you get it?"
        "Aina’s response shows nothing but bored irritation."
        aina "Touko, what’s the big deal,seriously? Are you that broken up that I prefer Shinn’s cock?"
        aina "Going along with Shinn gets me what I really want in life. That’s all there is to it."
        touko "What...?"
        aina "All the sex we had together was nothing compared to Shinn’s dick, get it?"
        aina "There’s one thing out there that’s really irreplaceable, and it’s just not you."
        shinn "Hahahahaha! "
        "Seeing how utterly Touko’s attempt at persuasion failed, I couldn’t hold in the laughter."
        shinn "See? I trained her well, Touko. This isn’t something you can change with words."
        "Touko is left in a total state of disbelief."
        "Looks like she doesn’t even understand what’s going on around her anymore."
        "She stares at Aina, now transformed into someone she doesn’t even recognize."
        aina "Come on, why don’t you join me? We can have lots of fun together with Master’s dick."
        "Still completely bewildered, Touko questions Aina again."
    else:
    ...
    if no_expose_touko:
        "Her luscious breasts and the pussy I’ve been waiting to taste are now fully exposed."
    else:
    ...
    if no_expose_touko:
        "Touko, who’s probably never had a dick in her face before this, looks apprehensive."
    else:
    ...
    touko "Mmm~"
    if no_expose_touko:
        "She must be thinking how different it is from the pleasure she’s gotten with Aina."
        shinn "Loving it, am I right?"
        shinn "I can tell you fell in love with my cock the moment you took it inside you."
    else:
