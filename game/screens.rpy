...
style bar:
    ysize gui.bar_size
    left_bar Frame("#C8F", gui.bar_borders, tile=gui.bar_tile)
    right_bar Frame("#316", gui.bar_borders, tile=gui.bar_tile)

style vbar:
    xsize gui.bar_size
    top_bar Frame("#316", gui.vbar_borders, tile=gui.bar_tile)
    bottom_bar Frame("#C8F", gui.vbar_borders, tile=gui.bar_tile)
    ...
    use game_menu(title):
        ...
        fixed:
            ...
            grid gui.file_slot_cols gui.file_slot_rows:
                ...
                for i in range(gui.file_slot_cols * gui.file_slot_rows):
                    ...
                    button:
                        ...
                        frame background "gui/button/save_[prefix_]marker.png" ypos 2

                        frame background "gui/button/save_[prefix_]marker.png" xpos 352 ypos -30
            ...
            hbox:
                ...
                imagebutton auto "gui/button/save_arrow_left_%s.png" action FilePagePrevious():
                    yoffset 10
                ...
                imagebutton auto "gui/button/save_arrow_right_%s.png" action FilePageNext():
                    yoffset 10
...
style pref_slot_time_text:
    foreground "gui/button/save_[prefix_]marker.png"
